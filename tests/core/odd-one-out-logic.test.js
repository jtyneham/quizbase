...
test("round selection honors difficulty and avoids recent relationships when possible", () => {
  const medium = chooseRound(ODD_ONE_OUT_BLUEPRINTS, "medium", ["mammals-and-fish"], deterministicRandom);
